...
type Querier interface {
	...
	DeleteConstructionSite(ctx context.Context, id uuid.UUID) (int64, error)
	...
	GetConstructionSite(ctx context.Context, id uuid.UUID) (ConstructionSite, error)
	...
	ListDocumentsBySite(ctx context.Context, siteID pgtype.UUID) ([]Document, error)
